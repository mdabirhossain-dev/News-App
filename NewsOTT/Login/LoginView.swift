...
struct LoginView: View {
    ...
    @State private var languageName: String = "en"
    var body: some View {
        NavigationView{
            ZStack{
                ...
                VStack(alignment: .center){
                    ...
                    VStack(alignment: .leading){
                        Text("login-str")
                            ...
                            .padding(.leading, 35)
                            .padding(.bottom, 20)
                        CustomTextField(RectangeHeight: 49, textFieldTitle: "email-str") {
                    ...
                    HStack{
                        Text("don’t-have-an-account?-str")
            ...
            .onAppear{
                languageName = UserDefaultsManager.shared.getString(forkey: "localization-language") ?? "en"
            }
        }.navigationViewStyle(StackNavigationViewStyle())
            .environment(\.locale, Locale.init(identifier: languageName))

    }
}

struct TabBarContollerWrapper: UIViewControllerRepresentable {
    func makeUIViewController(context: Context) -> TabBarContoller {
        return TabBarContoller()
    }
    
    func updateUIViewController(_ uiViewController: TabBarContoller, context: Context) {
    }
}
